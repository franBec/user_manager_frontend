...
import {
  SortDirection,
  UserSortProperty,
} from "@/__generated__/api/users/model";
...
export default function Users() {
  ...
  const [sortProperty] = useQueryState(
    "sortProperty",
    parseAsStringLiteral(Object.values(UserSortProperty)).withDefault("id")
  );
  const [sortDirection] = useQueryState(
    "sortDirection",
    parseAsStringLiteral(Object.values(SortDirection)).withDefault("ASC")
  );
